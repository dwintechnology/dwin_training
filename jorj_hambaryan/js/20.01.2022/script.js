...
let divInContaner = document.getElementsByClassName("divInContainer");
...
getPosts()
    .then((item) => {
        for (let index = 0; index < item.length; index++) {
            ...
            let delateCross = document.createElement('p');
            ...
            div.classList.add('divWH');
            button.className = 'buttonStyle';
            button.innerHTML = 'Comment';
            divOfTitle.className = 'divForTitle';
            delateCross.className = 'closeButton';
        ...
        if (btn_one.classList.contains('btn_one')) {
            for (let i of one) {
...
for (let i of btn) {
    i.addEventListener("click", function () {
        for (let index of btn) {
            index.classList.remove("btn_active");
        }
        i.classList.add("btn_active");
        if (i.classList.contains('btn_one')) {
            for (let index of divInContaner) {
        ...
        if (i.classList.contains('btn_two')) {
            for (let index of divInContaner) {
                index.classList.remove("show");
                index.classList.add('hide');
            }
        ...
        if (i.classList.contains('btn_thre')) {
            for (let index of divInContaner) {
                index.classList.remove("show");
                index.classList.add('hide');
            }
        ...
        if (i.classList.contains('btn_foue')) {
            for (let index of divInContaner) {
                index.classList.remove("show");
                index.classList.add('hide');
            }
        ...
        if (i.classList.contains('btn_four')) {
            for (let index of divInContaner) {
                index.classList.remove("show");
                index.classList.add('hide');
            }
        ...
        if (i.classList.contains('btn_five')) {
            for (let index of divInContaner) {
                index.classList.remove("show");
                index.classList.add('hide');
            }
